...
const IncomeState = () => {
  const navigation = useNavigation();
    return (
      ...
      <Text>
      {"\n"}
      <Text style={[styles.h2, styles.title]}>Income Statement For:</Text>{"\n"}
      ...
      <View style={styles.row}>
          <Text style={styles.cell}>PENDING ENDING MARCH 31, 2024</Text>
      </View>
      <View style={styles.row}>
      ...
      <View style={styles.row}>
          <Text style={styles.cell}>Total operating Expenses            XXXX.XX</Text>
      </View>
      <View style={styles.row}>
          <Text style={styles.cell}></Text>
      </View>
      <View style={styles.row}>
          <Text style={styles.cell}>Profit before income tax              XXXX.XX</Text>
      </View>
      <View style={styles.row}>
