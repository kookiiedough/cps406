...
const handleCellPress = (memberName, gender, age, level, coach) => {
  ...
  return (
    ...
    <TouchableOpacity onPress={() => handleCellPress("John Smith", "Male", 15, "Advanced", "James")} style={styles.row}>
        <Text style={styles.cell}>1. John Smith</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Jane Austin", "Female", 18, "Advanced", "James")} style={styles.row}>
        <Text style={styles.cell}>2. Jane Austin</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Harry Potter", "Male", 12, "Intermediate", "Luke")} style={styles.row}>
        <Text style={styles.cell}>3. Harry Potter</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Anakin Skywalker", "Male", 17, "Intermediate", "Luke")} style={styles.row}>
        <Text style={styles.cell}>4. Anakin Skywalker</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Matt Haig", "Male", 16, "Beginner", "Serena")} style={styles.row}>
        <Text style={styles.cell}>5. Matt Haig</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Peter Parker", "Male", 10, "Beginner", "Seo")} style={styles.row}>
        <Text style={styles.cell}>6. Peter Parker</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Khaled Hosseini", "Male", 15, "Beginner", "Seo")} style={styles.row}>
        <Text style={styles.cell}>7. Khaled Hosseini</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("R.F Kuang", "Male", 12, "Beginner", "Seo")} style={styles.row}>
        <Text style={styles.cell}>8. R.F Kuang</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Alex Haley", "Male", 12, "Advanced", "James")} style={styles.row}>
        <Text style={styles.cell}>9. Alex Haley</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Elif Shafak", "Female", 20, "Advanced", "Ahmed")} style={styles.row}>
        <Text style={styles.cell}>10. Elif Shafak</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Ramy Youssef", "Male", 20, "Intermediate", "Luke")} style={styles.row}>
        <Text style={styles.cell}>11. Ramy Youssef</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Elliot Alderson", "Male", 20, "Advanced", "Ahmed")} style={styles.row}>
        <Text style={styles.cell}>12. Elliot Alderson</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => handleCellPress("Olivia Rodigo", "Female", 21, "Beginner", "Seo")} style={styles.row}>
