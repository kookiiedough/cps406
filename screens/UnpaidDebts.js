...
const UnpaidDebts = () => {
    ...
    const bodyText = 'A list of the payments are waiting to be paid. Sort them based on the greatest amount you owe to the least, or the longest date over due to the most recent overdue payment. \n\n\nWhen you are ready, make a payment!';
  ...
  const handleDelete = () => {
    ...
    {renderLabel()} 
      ...
      <Button title="Make a Payment Now!" onPress={showDialog} color={"#557B2F"}/>
