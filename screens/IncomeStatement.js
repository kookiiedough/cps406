...
const IncomeStatement = () => {
    ...
    const bodyText = 'Revenue and expenses data are updated every 2 business days. Income statements are finalized on the last business day of each month. \n\n\nTo View an Income Statement: \n\n\n\n\n\n\n\n\n\n\n\n\nIt is recommended to view the revenue and expenses information before adding data to the income statement. ';
    ...
    const renderLabel = () => {
      if (value == 2) {
        return (
          navigation.navigate("IncomeState")
        );
      }
      return null;
    };
