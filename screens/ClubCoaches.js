	...
	return (
		<View style={styles.container}>
			...
			<View style={styles.table}>
				<TouchableOpacity
					onPress={() =>
						handleCellPress("Ahmed Azaiza", 15, "Advanced")
					}
					style={styles.row}
				>
				...
				<TouchableOpacity
					onPress={() =>
						handleCellPress("Hwang Hyunjin", 10, "Advanced")
					}
					style={styles.row}
				>
				...
				<TouchableOpacity
					onPress={() =>
						handleCellPress("James Potter", 18, "Advanced")
					}
					style={styles.row}
				>
				...
				<TouchableOpacity
					onPress={() =>
						handleCellPress("Luke Skywalker", 12, "Intermediate")
					}
					style={styles.row}
				>
				...
				<TouchableOpacity
					onPress={() =>
						handleCellPress("Yoon Kee-Ho", 22, "Intermediate")
					}
					style={styles.row}
				>
				...
				<TouchableOpacity
					onPress={() =>
						handleCellPress("Serena Williams", 12, "Beginner")
					}
					style={styles.row}
				>
				...
				<TouchableOpacity
					onPress={() =>
						handleCellPress("Seo Changbin", 17, "Beginner")
					}
					style={styles.row}
				>
